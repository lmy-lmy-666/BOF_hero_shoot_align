...
def generate_launch_description():
    ...
    # Locate simplified URDF: use hero_description from hero_shoot
    pkg_robot_desc = get_package_share_directory('hero_description')
    default_urdf = os.path.join(
        pkg_robot_desc, 'urdf', 'hero_robot.urdf.xacro'
    )
